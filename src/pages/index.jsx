      ...
      <section className={`snap-start w-screen min-h-screen flex flex-col items-center bg-2 text-main py-20 sm:py-0`}>
          <div className="w-full min-h-screen flex flex-col  justify-center items-center">
            ...
            <div className="flex flex-col sm:flex-row py-20 text-2xl gap-5 sm:gap-20">
              ...
              <div className="flex gap-2 justify-center items-center cursor-pointer py-4 px-1 border-b border-0 text-center border-[#330063] text-[#330063] hover:text-[#3300ff] duration-300 hover:border-[#3300ff]"><FaBuildingCircleCheck /> Contact</div>
            </div>
          </div>
